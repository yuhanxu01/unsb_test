...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp12_L2_sgl_E

# Experiment 12: Fully Paired - L2 Intermediate Single-Step + Entropy
...
export EXPERIMENT_NAME="ablation_exp12_fully_pair_L2_inter_single_E"
export N_EPOCHS=400
