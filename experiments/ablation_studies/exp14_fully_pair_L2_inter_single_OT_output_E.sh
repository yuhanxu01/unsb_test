...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp14_L2_OT_E

# Experiment 14: Fully Paired - L2 Intermediate Single-Step + OT Output + Entropy
...
export EXPERIMENT_NAME="ablation_exp14_fully_pair_L2_inter_single_OT_output_E"
export N_EPOCHS=400
